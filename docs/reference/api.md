...
| Empresa: ciclo de vida al abrir un turno (`getShift`, `listShiftApplications`, `resolveAssignment`) | asignaciones ordenadas por `id` (antes sin orden fijo) → turno |
